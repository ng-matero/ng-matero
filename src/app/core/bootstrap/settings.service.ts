...
import { enUS, Locale, ro, zhCN, zhTW } from 'date-fns/locale';
...
export class SettingsService {
  ...
  languages = ['en-US', 'ro', 'zh-CN', 'zh-TW'];

  localeMap: Record<string, Locale> = { 'en-US': enUS, 'ro': ro, 'zh-CN': zhCN, 'zh-TW': zhTW };
